...
<?php endif ?>	
<?php echo '<img src="' . plugins_url( 'Logo.png' , __FILE__ ) . '" > ';?>
	<div id="poststuff" class="metabox-holder has-right-sidebar">
			...
			<div class="inside">
				<form method="post" action="options.php" class="shortener-form">					
					...
					<p>
						...
						An API key is required to shorten URLs using your URL Shortener. <a href="https://ioli.ru/user/login" target="_blank">Your API key</a> </span>						
		...
		<div style="width:49.5%;float:left;overflow:hidden;margin-left:2%;" class="postbox right">
			...
			<div class="inside">
				...
				<p>If you have any questions, you can <a href="https://ioli.ru/v1/contact/" target="_blank">Contact </a> or <a href="https://ioli.ru/v1/developers/" target="_blank">Developer</a>.</p>
			</div>
		</div>					
	</div>
</div>