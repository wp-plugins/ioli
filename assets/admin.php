...
<div id="admin-header-new">
        ...
        <?php _e('URL Shortener Settings', 'shortener-plugin'); ?> | <?php _e('Version 1.6', 'shortener-plugin'); ?>
        </a>
        &nbsp;&nbsp;&nbsp;
        <a href="https://ioli.ru/page/Developers/" target="_blank"><i class="fa fa-file-text"></i> Documentation</a>
        &nbsp;&nbsp;
        <a href="https://ioli.ru/contact/" target="_blank"><i class="fa fa-life-ring"></i> Contact</a>
        &nbsp;&nbsp;
        <a href="https://ioli.ru/upgrade/" target="_blank"><i class="fa fa-shopping-cart"></i> iOli® Pro</a>
