 ...
 * ====================================================================================
 * ----------------------------------------------------------------------------------
 *  The WordPress plugin is built for the iOli Seo® Shortener Link that can bought from 
 *  iOli Seo®. This will not work with any other URL shorteners and I will not 
 *  implement it to other scripts.
 *
 *  Version 1.5
 *  Copyright (c) 2015 iOli Seo® - https://ioli.ru/v1/
 * ----------------------------------------------------------------------------------
 * ====================================================================================
 */
