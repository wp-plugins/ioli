...
This plugin uses the iOli API (https://ioli.ru/v1/developers/) all links are stored in WordPress and with iOli.
...
= 1.1 =
* Bug fixes, change css style and form shortener   
