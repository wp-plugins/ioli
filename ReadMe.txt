...
Tags: iOli, link shorten, short link, shorten url, url shortener, url, shorten
...
This plugin uses the iOli Seo® API (https://ioli.ru/v1/developers/) all links are stored in WordPress and with iOli.
...
= 1.4 =
* Update includes important cURL change config bug fixes. 
